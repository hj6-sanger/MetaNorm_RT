...
#Input is a text file with three columns, where the columns "X" and "Y" represent tissue type and the number of samples affected according to the 
count category (the column "type").
